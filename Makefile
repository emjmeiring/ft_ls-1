...
SRC = $(PATH_SRC)main.c $(PATH_SRC)parse.c $(PATH_SRC)display.c $(PATH_SRC)recursive_list.c $(PATH_SRC)sort.c $(PATH_SRC)flags.c $(PATH_SRC)populate.c

OBJ = main.o parse.o display.o recursive_list.o sort.o flags.o populate.o
